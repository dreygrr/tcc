...
@WebServlet("/ConcluirMetaController")
public class ConcluirMetaController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean concluiu = regcycleDAO.concluirMeta(id, usuario.getUsername());
